            ...
            <section class="col-md-12 ">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{route('customers.credit.pdf')}}" target="_blank" class="btn btn-success btn-sm float-right"><i class="fas fa-download"></i> Download PDF</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('invoice.details.pdf',$payment->invoice_id)}}" target="_blank" id="Details" title="Details" class="btn btn-sm btn-success"><i class="fas fa-eye"></i></a>
                                    </td>
                                    @php
