...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              <img src="{{(!empty(Auth::user()->image))?url('public/upload/user_images/'.Auth::user()->image):url('public/upload/users_images/no_image.png')}}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2020 <a href="https://appcommandos.com">AppCommandos</a>.</strong>
        All rights reserved.
        ...
        <script type="text/javascript">
          $(function(){
            $(document).on('click','#approved',function(e){
              ...
              let link =$(this).attr("href");
              Swal.fire({
                  title: 'Are you sure? Approved this Purchase',
                  text: "Please Doubel check to confirm!",
                  icon: 'warning',
                  showCancelButton: true,
                  confirmButtonColor: '#3085d6',
                  cancelButtonColor: '#d33',
